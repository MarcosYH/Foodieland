            ...
            filteredArticles.map((item, index) => (
              ...
              >
                <Image
                  src={item.image}
                  alt="noodle"
                  className=" md:mr-4 rounded-3xl max-h-[200px] mx-auto"
                />
                <div className=" text-center md:text-left">
                  ...
                  <div className="flex justify-center md:justify-start items-center my-8">
                    <div className="inline-flex items-center gap-3 pr-6 border-r-2">
                      <div className="w-[50px] h-[50px] bg-[#726d6d] rounded-full"></div>
